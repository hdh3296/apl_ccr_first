...
unsigned int tmpSetA1_Volt = 0; // tmp SER A1 Voltage, AN0
unsigned int tmpSetA2_Volt = 0; // tmp SER A2 Voltage, AN1
unsigned int tmpSetA3_Volt = 0; // tmp SER A3 Voltage, AN2
